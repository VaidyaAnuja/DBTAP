...
class AccountSettingsWorkshop extends StatefulWidget {
  @override
  _AccountSettingsWorkshopState createState() =>
      _AccountSettingsWorkshopState();
}

class _AccountSettingsWorkshopState extends State<AccountSettingsWorkshop> {
  int currentIndex = 1;
