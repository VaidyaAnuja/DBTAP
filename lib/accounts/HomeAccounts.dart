...
import 'package:beproject/accounts/account_accounts.dart';
...
class HomeAccounts extends StatefulWidget {
  @override
  _HomeAccountsState createState() => _HomeAccountsState();
}

class _HomeAccountsState extends State<HomeAccounts> with SingleTickerProviderStateMixin {
