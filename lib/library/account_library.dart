...
class AccountSettingsLibrary extends StatefulWidget {
  @override
  _AccountSettingsLibraryState createState() =>
      _AccountSettingsLibraryState();
}

class _AccountSettingsLibraryState extends State<AccountSettingsLibrary> {
  int currentIndex = 1;
