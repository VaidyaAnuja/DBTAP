...
import 'package:beproject/tpo/account_tpo.dart';
...
class HomeTPO extends StatefulWidget {
  @override
  _HomeTPOState createState() => _HomeTPOState();
}

class _HomeTPOState extends State<HomeTPO> with SingleTickerProviderStateMixin {
            ...
            Stack(
              children: [
                Container(
                    ...
                    builder: (context) => new HomeTPO()));
                    } else  {
                    Navigator.of(context).pushReplacement(new MaterialPageRoute(
                    builder: (context) => new AccountSettingsTPO()));
                    }
                    },
                    backgroundColor: HexColor("#0E34A0"),
